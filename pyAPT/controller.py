...
class Controller(object):
  ...
  def home(self, wait=False, velocity=None, offset=0):
    """
  ...
  def goto(self, abs_pos_mm, channel=1, wait=False):
    """
...
#      msg = self._wait_message(message.MGMSG_MOT_MOVE_COMPLETED)
  ...
  def move(self, dist_mm, channel=1, wait=False):
    """
  ...
  def stop(self, channel=1, immediate=False, wait=False):
    """
